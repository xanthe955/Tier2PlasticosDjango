...
INSERT INTO inventarios (nombre, descripcion, stock, cantidad_maxima, cantidad_minima, venta_maxima, venta_minima)
VALUES
...
INSERT INTO inventarios (nombre, descripcion, stock, cantidad_maxima, cantidad_minima, venta_maxima, venta_minima)
VALUES
    ('iPhone Azul', 'Descripción del iPhone Azul', 100, 200, 20, 10, 5),
    ('iPhone Verde', 'Descripción del iPhone Verde', 80, 180, 18, 9, 4),
    ('iPhone Amarillo', 'Descripción del iPhone Amarillo', 120, 190, 19, 9, 4),
    ('iPhone Morado', 'Descripción del iPhone Morado', 60, 170, 17, 8, 3),
    ('iPhone Rosa', 'Descripción del iPhone Rosa', 75, 160, 16, 8, 3),
    ('iPhone Cyan', 'Descripción del iPhone Cyan', 110, 220, 22, 12, 5);
